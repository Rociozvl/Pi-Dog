...
import Paginado from "../Pagination/Paginated";
import TemperamentsSelect from "../TemperamentsSelect/TemperamentsSelect";
import SearchBar from "../SearchBar/SearchBar";
import HomeCSS from "./Home.module.css"
//import SearchBarCSSS from "../SearchBajr/SearchBar";
//import HomeCSS from "./Home.module.css"
...
export default function Home(){
   ...
   const handleOrderByName = (e)=>{
       ...
       setCurrentPage(1)
       setOrder(`Sorting out ${e.target.value}`)
   }
   const handleOrderByWeight=(e)=>{
       dispatch(OrderByName(e.target.value))
       setCurrentPage(1)
       setOrder(`Sorting out${e.value}`)
   }
   return (
